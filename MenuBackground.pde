private class MenuBackground implements DisplayInterface {
	private final int matrixSize=10;
	private PImage glassTexture;
	private PImage tempBackground;
	
	public MenuBackground(){
		this.tempBackground=loadImage("data/background.jpg");
	...
	public void display(){
		image(this.tempBackground,width/2,height/2,width,height);
	}

	public void saveChanges(){
		this.tempBackground.save("data/background.jpg");
	}
}
